...
public class CommonUtil {
    ...
    public final static  String appid            = "wxb2a5dc2db12703e7";
    public final static  String appsecret        = "f21fda303f5b5c883a5868cc4abfd7b8";
	...
	Token token = null;
	String requestUrl = token_url.replace( "APPID", CommonUtil.appid ).replace( "APPSECRET", CommonUtil.appsecret );
     ...
     *
     * @param url   授权重定向地址
     * @param Scope 授权类型 snsapi_base （不弹出授权页面，直接跳转，只能获取用户openid） snsapi_userinfo
	...
	String authUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=" + CommonUtil.appid + "&redirect_uri=" + CommonUtil.urlEncodingUTF8( authRedirectUrl )
